...
BrockGroup:
	...
	db 41, GOLEM,      HARD_STONE,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 41, RHYPERIOR,  HARD_STONE,   FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 42, GLISCOR,    HARD_STONE,   GUILLOTINE, SCREECH, SLASH, IRON_TAIL
	db 44, MAMOSWINE,  HARD_STONE,   BLIZZARD, EARTHQUAKE, AMNESIA, SANDSTORM
	db 43, LYPRESS,    HARD_STONE,   ROCK_SLIDE, SLAM, FAINT_ATTACK, MIMIC
	db 42, KLEAVOR,    HARD_STONE,   FURY_CUTTER, ROCK_THROW, SLASH, SWORDS_DANCE
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_ITEM_MOVES
	db 42, POLITOED,   MYSTIC_WATER, SURF, PERISH_SONG, HYPNOSIS, HYDRO_PUMP
	db 42, QUAGSIRE,   MYSTIC_WATER, SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 44, LANTURN,    MYSTIC_WATER, SURF, CONFUSE_RAY, THUNDER, THUNDER_WAVE
	db 44, LAPRAS,     MYSTIC_WATER, SURF, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 45, NORWHOL,    MYSTIC_WATER, SURF, ICE_BEAM, REST, SLEEP_TALK
	db 47, STARMIE,    MYSTIC_WATER, SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_ITEM_MOVES
	db 44, RAICHU,     MAGNET,      THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 43, JOLTEON,    MAGNET,      THUNDER_WAVE, AGILITY, PIN_MISSILE, THUNDERBOLT
	db 43, MAGNEZONE,  MAGNET,      LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 44, LECTROLITE, MAGNET,      SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 46, ELECTABUZZ, MAGNET,      QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db 47, ELECTIVIRE, MAGNET,      ICE_PUNCH, CROSS_CHOP, BARRIER, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db 42, TANGROWTH,  MIRACLE_SEED, VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 41, MEGANIUM,   MIRACLE_SEED, POISON_POWDER, LEECH_SEED, LIGHT_SCREEN, GIGA_DRAIN
	db 43, LEAFEON,    MIRACLE_SEED, GIGA_DRAIN, SAND_ATTACK, HYPER_BEAM, SUNNY_DAY
	db 44, BELLRAUNE,  MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, CRUNCH, PETAL_DANCE
	db 46, VICTREEBEL, MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, ACID, RAZOR_LEAF
	db 46, BELLOSSOM,  MIRACLE_SEED, SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
JanineGroup:
	...
	db 36, CROBAT,     POISON_BARB,  SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 36, QWILFISH,   POISON_BARB,  SURF, SLUDGE_BOMB, PIN_MISSILE, TOXIC
	db 37, VILEPLUME,  POISON_BARB,  PETAL_DANCE, TOXIC, SYNTHESIS, SLUDGE_BOMB
	db 38, GASSPING,   POISON_BARB,  PSYCHIC_M, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 35, NIDOQUEEN,  POISON_BARB,  EARTHQUAKE, SLUDGE_BOMB, FLAMETHROWER, ICE_BEAM
	db 39, VENOMOTH,   POISON_BARB,  FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, ESPEON,     TWISTEDSPOON, SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db 46, SLOWKING,   TWISTEDSPOON, AMNESIA, PSYCHIC_M, SURF, DISABLE
	db 44, WOBBUFFET,  TWISTEDSPOON, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 46, WYRDEER,    TWISTEDSPOON, HYPNOSIS, STOMP, CONFUSE_RAY, PSYCHIC_M
	db 47, DORMARE,    TWISTEDSPOON, HYPNOSIS, DREAM_EATER, NIGHTMARE, FUTURE_SIGHT
	db 48, ALAKAZAM,   TWISTEDSPOON, RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
FisherGroup:
	...
	db 34, SEAKING,    SUPERSONIC, WATERFALL, FLAIL, FURY_ATTACK
	db 38, CHINCHOU,   CONFUSE_RAY, SPARK, SURF, TAKE_DOWN
	db -1 ; end
...
BlaineGroup:
	...
	db 45, MAGCARGO,   CHARCOAL,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
	db 45, ARCANINE,   CHARCOAL,   FLAME_WHEEL, EXTREMESPEED, DIG, DRAGONBREATH
	db 45, MAGMAR,     CHARCOAL,   THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 47, TYPHLOSION, CHARCOAL,   FLAMETHROWER, SWIFT, DIG, THUNDERPUNCH
	db 48, WHELKANO,   CHARCOAL,   IRON_TAIL, FLAMETHROWER, ACID_ARMOR, FIRE_BLAST
	db 50, MAGMORTAR,  CHARCOAL,   THUNDERPUNCH, FLAMETHROWER, CONFUSE_RAY, FIRE_BLAST
	db -1 ; end
...
BlueGroup:
	...
	db 56, PIDGEOT,    SHARP_BEAK,   QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 54, ALAKAZAM,   TWISTEDSPOON, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 56, RHYPERIOR,  SOFT_SAND,    FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 58, GYARADOS,   MYSTIC_WATER, TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 58, EXEGGUTOR,  MIRACLE_SEED, SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db 58, ARCANINE,   CHARCOAL,     ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
