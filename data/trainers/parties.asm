...
FalknerGroup:
	...
	db  8, HOOTHOOT,   TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
...
WhitneyGroup:
	...
	db 19, FURRET,     QUICK_ATTACK, DEFENSE_CURL, MUD_SLAP, ROLLOUT
...
BugsyGroup:
	...
	db 15, PINECO,     PIN_MISSILE, BIDE, TACKLE, NO_MOVE
...
PryceGroup:
	...
	db 30, SNEASEL,    FAINT_ATTACK, ICY_WIND, FURY_SWIPES, SCREECH
...
KarenGroup:
	...
	db 44, BELLRAUNE,  SYNTHESIS, SLEEP_POWDER, CRUNCH, PETAL_DANCE
