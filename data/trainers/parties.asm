...
BrockGroup:
	...
	db 52, GLISCOR,    HARD_STONE,   GUILLOTINE, SCREECH, SLASH, IRON_TAIL
	db 52, MAMOSWINE,  HARD_STONE,   BLIZZARD, EARTHQUAKE, AMNESIA, SANDSTORM
...
ErikaGroup:
	...
	db 53, LEAFEON,    MIRACLE_SEED, GIGA_DRAIN, SAND_ATTACK, HYPER_BEAM, SUNNY_DAY
