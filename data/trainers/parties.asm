...
WillGroup:
	...
	db 42, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 43, WYRDEER,    PSYCHIC_M, CONFUSE_RAY, HYPNOSIS, BITE
	db -1 ; end
...
BrunoGroup:
	...
	db 43, HERCULASH,  MEGAHORN, CROSS_CHOP, THIEF, DETECT
	db 44, POLIWRATH,  HYPNOSIS, SURF, MIND_READER, DYNAMICPUNCH
...
KarenGroup:
	...
	db 43, WEAVILE,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 44, GENGAR,     LICK, SPITE, CURSE, DESTINY_BOND
	db 45, KELPIQUUS,  FAINT_ATTACK, HYDRO_PUMP, AGILITY, SMOKESCREEN
	db 46, BELLRAUNE,  SYNTHESIS, SLEEP_POWDER, CRUNCH, PETAL_DANCE
...
KogaGroup:
	...
	db 43, NIDOKING,   TOXIC, FIRE_PUNCH, THUNDER_PUNCH, ICE_PUNCH 
...
ChampionGroup:
	...
	db 47, TROPIPOD,   SUNNY_DAY, DRAGONBREATH, SOLARBEAM, HYPER_BEAM
	db 47, KINGDRA,    HYDRO_PUMP, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 46, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 46, T_NEPRES,   SLUDGE_BOMB, DRAGONBREATH, CRUNCH, HYPER_BEAM
...
BrockGroup:
	...
	db 41, GOLEM,      DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 41, RHYPERIOR,  FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 42, GLISCOR,    GUILLOTINE, SCREECH, SLASH, IRON_TAIL
	db 44, MAMOSWINE,  BLIZZARD, EARTHQUAKE, AMNESIA, SANDSTORM
	db 43, LYPRESS,    ROCK_SLIDE, SLAM, FAINT_ATTACK, MIMIC
	db 42, KLEAVOR,    FURY_CUTTER, ROCK_THROW, SLASH, SWORDS_DANCE
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 42, POLITOED,   SURF, PERISH_SONG, HYPNOSIS, HYDRO_PUMP
	db 42, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 44, LANTURN,    SURF, CONFUSE_RAY, THUNDER, THUNDER_WAVE
	db 44, LAPRAS,     SURF, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 45, NORWHOL,    SURF, ICE_BEAM, REST, SLEEP_TALK
...
LtSurgeGroup:
	...
	db 43, JOLTEON,    THUNDER_WAVE, AGILITY, PIN_MISSILE, THUNDERBOLT
	db 43, MAGNEZONE,  LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 44, LECTROLITE, SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 46, ELECTABUZZ, QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db 47, ELECTIVIRE, ICE_PUNCH, CROSS_CHOP, BARRIER, THUNDER
	db -1 ; end
...
ErikaGroup:
	...
	db 42, TANGROWTH,  VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
	db 41, MEGANIUM,   POISON_POWDER, LEECH_SEED, LIGHT_SCREEN, GIGA_DRAIN
	db 43, LEAFEON,    GIGA_DRAIN, SAND_ATTACK, HYPER_BEAM, SUNNY_DAY
	db 44, BELLRAUNE,  SUNNY_DAY, SYNTHESIS, CRUNCH, PETAL_DANCE
...
JanineGroup:
	...
	db 36, QWILFISH,   SURF, SLUDGE_BOMB, PIN_MISSILE, TOXIC
	db 37, VILEPLUME,  PETAL_DANCE, TOXIC, SYNTHESIS, SLUDGE_BOMB
	db 38, GASSPING,   PSYCHIC_M, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 35, NIDOQUEEN,  EARTHQUAKE, SLUDGE_BOMB, FLAMETHROWER, ICE_BEAM
...
SabrinaGroup:
	...
	db 46, SLOWKING,   AMNESIA, PSYCHIC_M, SURF, DISABLE
	db 44, WOBBUFFET,  COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 46, WYRDEER,    HYPNOSIS, STOMP, CONFUSE_RAY, PSYCHIC_M
	db 47, DORMARE,    HYPNOSIS, DREAM_EATER, NIGHTMARE, FUTURE_SIGHT
...
BlaineGroup:
	...
	db 45, ARCANINE,   FLAME_WHEEL, EXTREMESPEED, DIG, DRAGONBREATH
	db 45, MAGMAR,     THUNDERPUNCH, FIRE_PUNCH, SUNNY_DAY, CONFUSE_RAY
	db 47, TYPHLOSION, FLAMETHROWER, SWIFT, DIG, THUNDERPUNCH
	db 48, WHELKANO,   IRON_TAIL, FLAMETHROWER, ACID_ARMOR, FIRE_BLAST
	db 50, MAGMORTAR,  THUNDERPUNCH, FLAMETHROWER, CONFUSE_RAY, FIRE_BLAST
	db -1 ; end
...
BlueGroup:
	...
	db 56, RHYPERIOR,  FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
