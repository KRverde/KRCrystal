...
.u:        db ARCANINE, SUDOWOODO, WEEPINBELL, BELLRAUNE, VICTREEBEL, WOOPER, SWINUB, -1
...
.sa_za:    db RHYHORN, PUPITAR, CORSOLA, HITMONLEE, JOLTEON, SANDSHREW, SANDSLASH, -1 ; RHYDON should lead this list
...
.to_do:    db DODUO, DODRIO, SMEARGLE, KOFFING, GASSPING, TENTACRUEL, TOGETIC, TOGEPI, GOLDEEN, METAPOD, DONPHAN, -1
...
.ne:       db NATU, XATU, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, HERCULASH, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, BLISSEY, PARAS, PARASECT, QWILFISH, MR__MIME, TYROGUE, CLOYSTER, TYRANITAR, -1
...
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, BULBASAUR, VENUSAUR, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, JIGGLYPUFF, SNUBBULL, -1
