...
.ka_ga:    db GROWLITHE, KELPIQUUS, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, BLASTOISE, FARFETCH_D, -1
.ki_gi:    db SUNFLORA, CATERPIE, GYARADOS, BELLOSSOM, KINGDRA, KINGLER, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, GRANBULL, GLACEON, CROBAT, -1
...
.to_do:    db SMEARGLE, KOFFING, GASSPING, TENTACRUEL, TOGETIC, TOGEPI, GOLDEEN, METAPOD, DORMARE, TROPIUS, TROPIPOD, DONPHAN, -1
...
.fu_bu_pu: db FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, VENUSAUR, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, JIGGLYPUFF, SNUBBULL, -1
...
.ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, MANTINE, -1
.mi:       db DRATINI, MILTANK, -1
.mu:       db SMOOCHUM, -1
.me:       db MEGANIUM, DITTO, TENTACOOL, -1
.mo:       db VENOMOTH, TANGELA, -1
